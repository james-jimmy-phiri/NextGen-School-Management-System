...
import { AlertCircle, ChevronRight, Save, ArrowLeft } from 'lucide-react';
...
const DRAFT_KEY = 'admin_admission_form_draft';
...
export default function Create() {
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Create Admission Application" />
            ...
            <div className="max-w-4xl mx-auto py-8">
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        ...
                        <h1 className="text-3xl font-bold text-gray-900 tracking-tight">New Application</h1>
                        <p className="text-gray-500 mt-1">Enter a new student admission application manually.</p>
                    </div>
                </div>
                                ...
                                <React.Fragment key={s.num}>
                                    <div className={cn("flex flex-col items-center", step >= s.num ? "text-primary" : "text-gray-400")}>
                                        <div className={cn("w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold border-2 transition-colors", 
                                            step >= s.num ? "border-primary bg-primary/10" : "border-gray-300 bg-white"
                                        )}>
                                            {s.num}
                                        </div>
                            ...
                            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                                <div>
                                    ...
                                    <div className="bg-blue-50 border border-blue-200 text-blue-800 rounded-xl p-4 flex gap-3 text-sm">
                                        ...
                                        <p>Please upload clear, legible copies. Max size per file is 5MB.</p>
                                    </div>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
