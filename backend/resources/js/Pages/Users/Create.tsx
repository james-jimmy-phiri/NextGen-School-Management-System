...
export default function UsersCreate({ roles, schools }: Props) {
            ...
            <div className="mx-auto max-w-3xl space-y-8">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        ...
                        <h1 className="mt-1 text-3xl font-bold tracking-tight text-foreground">Add user</h1>
                        <p className="mt-2 text-sm text-muted-foreground">
                            Create an account and assign a single primary role. Permissions come from that role.
                        </p>
                    </div>
                    <Link
