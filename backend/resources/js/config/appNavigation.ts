...
export const defaultNavBlocks: NavBlockConfig[] = [
    ...
    },
    {
        ...
        visible: (c) => staff(c) && c.isOperationalLead,
        children: [
            { kind: 'leaf', label: 'Fee structures', icon: Receipt, erpPageKey: 'finance-fee-structures' },
            { kind: 'leaf', label: 'Invoices', icon: FileBarChart, erpPageKey: 'finance-invoices' },
            { kind: 'leaf', label: 'Payments', icon: Wallet, erpPageKey: 'finance-payments' },
    ...
    },
    {
        ...
        visible: staff,
        children: [
            { kind: 'leaf', label: 'Announcements', icon: Megaphone, erpPageKey: 'communication-announcements' },
